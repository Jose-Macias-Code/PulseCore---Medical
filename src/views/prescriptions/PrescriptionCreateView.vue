<template>
  <div class="prescriptions-create-view">
    ...
    <section class="header">
      <div class="header-text">
        <h1 class="header-title">
          ...
          New Recipe For <span class="name-patient">{{ patient.firstName }}</span>
        </h1>
      </div>
    ...
    <div class="form-container" v-if="patient">
    ...
    <div v-else class="toast-error">
      <i class="ri-error-warning-line icon"></i>
      Patient not found. Please go back and select one.
    </div>
  </div>
</template>
...
export default {
  ...
  created() {
    const { patient_id, first_name } = this.$route.query
    ...
    if (patient_id && first_name) {
      ...
      console.warn('Missing patient info in route query:', this.$route.query)
    }
  },
  methods: {
    handleSubmit() {
